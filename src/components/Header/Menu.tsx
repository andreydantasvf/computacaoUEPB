...
export const Menu = () => {
  ...
  return (
    <div className={`${!isMenuOpen && 'hidden'} w-full lg:w-fit h-[calc(100vh-80px)] lg:h-fit absolute lg:static top-[95%] bg-[#7895CB] px-4 py-2 z-20 border-t-2 lg:border-none border-[#2E4374] lg:block lg:order-2`}>
      <ul className="font-semibold text-lg lg:text-base flex flex-col items-center lg:flex-row gap-4">
        ...
        <li>
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-2 hover:text-blue-800 transition duration-300 ease-in-out relative after:bg-blue-500 after:absolute after:h-1 after:w-0 after:-bottom-2 after:left-0 hover:after:w-full after:transition-all after:duration-300">Graduação <AiFillCaretRight /></DropdownMenuTrigger>
